...
public class GralogColor implements Serializable {
    ...
    //NEW MAXFLOW COLOURS 
    public static final GralogColor MINT = new GralogColor(0x669966);
    public static final GralogColor BABYBLUE = new GralogColor(0xd8e5ef);
    public static final GralogColor SEAFOAM = new GralogColor(0x007471);
    public static final GralogColor TANGERINE = new GralogColor(0xe16f00);
    public static final GralogColor DUSK = new GralogColor(0x334db3);
    public static final GralogColor CORAL = new GralogColor(0xff8080);
    public static final GralogColor TRANSPARENT = new GralogColor(0xf2f2f2);
